...
- I wrote all of the Objective-C code and functionality of the app.
...
- I also created the information screen where people can sign up to find a friend at an event, as well as the table view afterwards which displays the list of friends available to go to the event with you.
